					...
					<table id="tablaExport" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<tr>
								...
								<td></td>
								<td class="d-flex">
									<a class="btn btn-primary btn-circle btn-sm" href="{{ route('ventas.show', ['slug' => 1]) }}"><i class="fa fa-briefcase"></i></a>&nbsp;&nbsp;
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">¿Estás seguro de que quieres eliminar esta venta?</h5>
