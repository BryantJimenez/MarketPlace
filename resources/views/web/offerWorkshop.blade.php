...
@section('title', 'Registrar Taller')
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 ftco-animate">
				<p class="h2">Inicia sesión o registrate para continuar con el registro de tu taller.</p>
			</div>
			<div class="col-12">
			...
			@else
			<div class="col-12 ftco-animate">
				<p class="h2">Registro del Taller</p>
				<p>Envía el formulario con todos los datos, la solicitud de tu taller sera revisada y aceptada de cumplir con todos los requerimientos.</p>
				...
				<form action="{{ route('servicios.offer.shop.store') }}" method="POST" class="billing-form" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-12">
							<p class="h5">Datos del Taller</p>
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Nombre<b class="text-danger">*</b></label>
									<input class="form-control" type="text" name="name_workshop" required placeholder="Introduzca un nombre" value="{{ old('name_shop') }}">
								</div>
								<div class="form-group col-lg-6 col-md-6 col-12">
								...
								<div class="form-group col-12">
									...
									<input class="form-control" type="text" name="address_workshop" required placeholder="Selecciona una dirección" readonly value="{{ old('address_shop') }}" id="addressDelivery">
								</div>
								<div class="form-group col-12">
